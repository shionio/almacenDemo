			...
			<div class="row">
				<div class="col-12">
					<div class="card card-danger">
			            ...
			            <!-- /.card-header -->
			           	<!-- form start -->
			            <form action="{{route('editarAlmacen')}}" method="POST">
		            {{-- {{session('id_usuario')}} --}}
			            	@csrf
			            	<input type="hidden" name="id" value="{{$almacen->id_almacen}}">
			            	<input type="hidden" name="id2" value="{{$almacen->id_ubicacion_geografica}}">
			            	...
			            	<div class="card-body row">
				                <div class="form-group col-2">
			                  	...
			                  	<div class="form-group col-2">
			                    	...
			                    	<input type="text" name="nombreAlmacen" class="form-control" id="exampleInputPassword1" value="{{$almacen->nombre_almacen}}">
			                  	</div>
				                ...
				                <div class="col-sm-2">
				                    ...
				                    <div class="form-group">
				                        ...
				                        <select class="js-example-basic-single custom-select" name="estado" id="estado" onchange="llenarMunicipios()" required>
				                        	<option value="">{{$almacen->estado}}</option>
			                    ...
			                    <div class="col-sm-3">
			                      	...
			                      	<div class="form-group">
			                        	...
			                        	<select class="js-example-basic-single custom-select" name="municipio" id="municipio" onchange="llenarParroquias()" required>
			                          		<option value="null">{{$almacen->municipio}}</option>
			                        	</select>
			                      	</div>
			                    </div>
			                    ...
			                    <div class="col-sm-3">
			                      	...
			                      	<div class="form-group">
			                        	...
			                        	<select class="js-example-basic-single custom-select" name="parroquia" id="parroquia" required>
			                          		<option value="null">{{$almacen->parroquia}}</option>
			                        	</select>
			                      	</div>
			                    </div>
			                    ...
			                    <div class="col-sm-3">
			                      	...
			                      	<div class="form-group">
			                        	...
			                        	<input type="text" name="direccionAlmacen" class="form-control" id="exampleInputPassword1" value="{{$almacen->direccion}}" required>
			                      	</div>
			                    </div>
			                     ...
			                     <div class="col-sm-3">
			                      	...
			                      	<div class="form-group">
			                        	...
			                        	<input type="text" name="codigoPostal" id="codPostal" class="form-control" onkeypress="return valideKey(event)" value="{{$almacen->cod_postal}}" required>
			                      	</div>
			                    </div>
			                      	...
			                      	<div class="form-group">
			                        	<label>Tipo Almacen</label>
			                        		<select class="js-example-basic-single custom-select" name="tipoAlmacen" required>
			                        			<option value="" selected="true">{{$almacen->tipo_almacen}}</option>
			                    ...
			                    <div class="col-sm-3">
			                      	...
			                      	<div class="form-group">
			                        	<label>Condicion Almacen</label>
			                        		<select class="js-example-basic-single custom-select" name="condicionAlmacen" required>
			                        			<option value="" selected="true">{{$almacen->condicion_almacen}}</option>
			                     ...
			                     <div class="col-sm">
			                      	...
			                      	<div class="form-group">
			                        	...
			                        	<input type="text" name="descripcionAlmacen" id="" class="form-control" value="{{$almacen->descripcion_almacen}}" required>
			                      	</div>
			                    </div>
